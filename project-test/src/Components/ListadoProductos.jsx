...
const productos = [
  {
    name: "Open Space",
    descripcion: "El lugar ideal para que trabajes solo con tu equipo. Comodidad y Espacio Asegurados, Mobiliario de Última generación. ",
  ...
  const getRandomProducts = () => {
    const randomProducts = [...productos].sort(() => Math.random() - 0.5).slice(0, 10);
