    ...
    <div className="segmento-categorias">
      {/* <h3 className="txt-titulo-servicio">Busca por tipo de servicio</h3> */}
       ...
       <div className="card-categoria">
          <div className="fondo-icono-categoria">
            <HiOutlineBuildingOffice2
              style={{ color: "grey", fontSize: "60px" }}
            />
        ...
        <div className="card-categoria">
          <div className="fondo-icono-categoria">
            <HiOutlineHome style={{ color: "grey", fontSize: "60px" }} />
      ...
      <div className="card-categoria">
        <div className="fondo-icono-categoria">
          <GiOfficeChair style={{ color: "grey", fontSize: "60px" }} />
      ...
      <div className="card-categoria">
        <div className="fondo-icono-categoria">
          <HiOutlineTv style={{ color: "grey", fontSize: "60px" }} />
      ...
      <div className="card-categoria">
        <div className="fondo-icono-categoria">
          <HiMiniComputerDesktop style={{ color: "grey", fontSize: "60px" }} />
      ...
      {/* <div className="card-categoria">
        <div className="fondo-icono-categoria">
          <HiOutlinePrinter style={{ color: "grey", fontSize: "60px" }} />
          <div className="nombre-icono-categoria">Impresiones</div>
        </div> */}
      {/* </div> */}
     </div>
